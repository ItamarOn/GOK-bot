...
TEXTS = {
    ...
    "thanks": (
        ...
        "🧙‍♂️ אם ברצונך להודות ליוצרי המיזם ניתן לתרום לארגון GOK בלינק:\n"
        "https://kosher.global/support-zekasher 🙏"
    ),
    "reaction" : "תודה שהגבת לי ונתת חיווי של {sign}, ובכל זאת... ",
    "bug" : {
    ...
    "left_time": {
        "moments": "כמה רגעים",
        "minutes_only": "{minutes} דקות",
        "hour_and_minutes": "שעה ו{minutes} דקות",
    ...
    "group": {
        ...
        "listed": "המוצר קיים במאגר המוצרים *(כשר / לא כשר)* באתר\n"
                  "הקפידו לבדוק לפני שליחה בקבוצה\n"
                  "שאלו אותי בפרטי או בידקו באתר\n"
